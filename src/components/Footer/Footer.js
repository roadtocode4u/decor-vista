...
function Footer() {
  return (<>
    ...
    <div className='text-white p-3 m-2 '>     
        ...
        <Link to="https://github.com/shriyaborkar358"className='links text-decoration-none text-white'><img src='https://cdn-icons-png.flaticon.com/128/5968/5968866.png'  className='logo-2 mx-2'/></Link>
